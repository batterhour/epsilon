# Epsilon Blockchain Stats

Epsilon Blockchain Stats utlity exports daily statistics for the epsilon blockchain from creation through current state.

## Usage:

See also the utility's help option. `epsilon-blockchain-stats --help`
...
- `epsilon-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `epsilon-blockchain-stats | save-to-database.sh`
