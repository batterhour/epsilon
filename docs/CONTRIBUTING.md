...
posted to #epsilon-dev on irc.libera.chat).
...
The "Epsilon Maintainer Team" is defined in this document as the following users:
- fluffypony
- epsilonmooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Epsilon code or Epsilon's dependency code or Epsilon's potential/future dependency code or research which successfully implements Epsilon.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Epsilon Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Epsilon Maintainer Team.
